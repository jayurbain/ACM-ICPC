////////////////////////////////////////////////////////////////////
//    Aquarium Tank, Rocky Mountain 2014 J
//    Solution by Ed Corwin
////////////////////////////////////////////////////////////////////
#include <iostream>
#include <fstream>
#include <iomanip>
...
////////////////////////////////////////////////////////////////////
//   Rocky Mountain says counterclockwise
//   Wrote code for clockwise from bottom left
////////////////////////////////////////////////////////////////////
...
double find_height(point p[], int n, double desired_area)
  ...
  for (i = 0; i < n; i++)
    if (p[i] . y > high)
      high = p[i] . y;  
  for (mid = step(); mid <= high; mid += step())
    {
...
int main()
  ...
  while (inf >> n)
    ...
    result_int = int(result * check_power() + 0.1);
    cout << setprecision(N_DIGITS);
